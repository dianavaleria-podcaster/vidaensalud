...
<body>
    <div class="main-wrapper">
        <header class="header-nav">
            ...
            <a href="../suscripcion/index.html" class="btn-rojo">Suscríbete a la Newsletter</a>
        </header>
        ...
        <article class="episode-content">
            ...
            <div class="episode-description">
                <p style="margin-bottom: 25px; background: #f1f5f1; padding: 15px; border-radius: 8px; border-left: 4px solid var(--verde-salud);">
                    <strong>📬 ¿Te gusta este podcast? <a href="../suscripcion/index.html" style="color: var(--verde-salud); text-decoration: underline;">Suscríbete a la Newsletter y obtén ofertas especiales</a></strong>
                </p>
                {description}
            </div>
